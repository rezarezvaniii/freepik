        ...
        <div className="w-4/12 h-full flex items-center justify-center">
          ...
          <Card className=" w-full max-w-[24rem] border-2 border-gray-500/20 ">
            <CardHeader
              variant="gradient"
              color="white"
              className="mb-4 bg-[#13234D] border-2 border-gray-500/30 grid h-28 w-11/12 -top-12 m-auto place-items-center"
              ...
              >
                <Form className="flex flex-col gap-5">
                  ...
                  <div className="-ml-2.5">
                    <p>در صورت وجود اکانت <Link className="text-blue-500" to={"/"}>وارد</Link> شوید</p>
                  </div>
